...
const returns: Return[] = [
  ...
  { id: "a1b2c3d4", amount: 150, status: "success", email: "julien.dupont@gmail.com", dateOfRequest: "2025-01-15" },
  { id: "e5f6g7h8", amount: 980, status: "failed", email: "sophie.leroy@yahoo.fr", dateOfRequest: "2025-02-20" },
  { id: "i9j1k2l3", amount: 300, status: "pending", email: "marc.tremblay@outlook.com", dateOfRequest: "2025-03-05" },
  { id: "m4n5o6p7", amount: 1200, status: "success", email: "emma.bernard@hotmail.fr", dateOfRequest: "2025-01-28" },
  { id: "q8r9s1t2", amount: 75, status: "failed", email: "alexandre.rossi@gmail.com", dateOfRequest: "2025-02-10" },
  { id: "u3v4w5x6", amount: 450, status: "pending", email: "laura.moreau@yahoo.com", dateOfRequest: "2025-03-01" },
  { id: "y7z8a9b1", amount: 650, status: "success", email: "nicolas.martin@outlook.fr", dateOfRequest: "2025-02-18" },
  { id: "c2d3e4f5", amount: 275, status: "failed", email: "claire.dubois@gmail.com", dateOfRequest: "2025-01-30" },
  { id: "g6h7i8j9", amount: 820, status: "pending", email: "thomas.leclercq@hotmail.com", dateOfRequest: "2025-02-25" },
  { id: "k1l2m3n4", amount: 999, status: "success", email: "amelie.perrot@yahoo.fr", dateOfRequest: "2025-03-10" },
];
...
const getStatusBadge = (status: string) => {
  switch (status) {
    ...
    case "processing":
      return (
        <Badge className="bg-amber-600/10 dark:bg-amber-600/20 hover:bg-amber-600/10 text-amber-500 shadow-none rounded-full">
          <div className="h-1.5 w-1.5 rounded-full bg-amber-500 mr-2" /> Processing
        </Badge>
      );
    case "failed":
      return (
      ...
      <Card className="w-full">
        ...
        <CardContent>
          ...
          <div className="flex flex-col mt-4 items-center w-full">
            ...
            <p className="opacity-50 text-sm">Trop petit, souhaité plus grand</p>
          </div>
          <Separator className="my-4" />
          {/* Historique / Timeline */}
          <div className="flex flex-col items-center w-full">
            <div><Label>Historique / Timeline :</Label>
